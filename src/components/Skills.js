...
const skillNames = [
  ...
  "React.js", "React Native", "Next.js", "Flutter",
  "HTML", "CSS", "Tailwind CSS", "Bootstrap",
  "Laravel", "PHP", "Firebase", "Git", "AWS",
];
...
const Skills = () => {
  return (
    <>
      ...
      <div
        className="hidden md:flex w-full h-screen relative items-center justify-center rounded-full bg-circularLight mb-56">
        <motion.div
        ...
        <Skill name="React Native" x="14vw" y="1vw"/>
